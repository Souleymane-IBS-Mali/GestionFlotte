...
/**
 * \file    test/phpunit/GestionFlotteFunctionalTest.php
...
/**
 * Class GestionFlotteFunctionalTest
 *
 ...
 *
 * @package Testgestionflotte
 */
class GestionFlotteFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 800000; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modGestionFlotte')->click();
		} else {
			// Disable the module
			$this->byHref('modGestionFlotte')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/gestionflotte/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('gestionflotte/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/gestionflotte/admin/about.php');
		$this->authenticate();
		return $this->assertContains('gestionflotte/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('gestionflottewidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modGestionFlotte_GestionFlotteTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modGestionFlotte_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
