...
class Form1
{
	...
	public function formconfirm1($page, $title, $question, $action, $formquestion = '', $selectedchoice = '', $useajax = 0, $height = 0, $width = 500, $disableformtag = 0)
	{
		global $langs, $conf;
		...
		if ($useajax) {
			...
			$formconfirm .= '
                    ...
                    closeOnEscape: false,
                    buttons: {
                        "'.dol_escape_js($langs->transnoentities("Créer")).'": function() {
