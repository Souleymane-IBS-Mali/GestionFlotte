...
if($etat == 'stationne')
	header('Location: ./vehicule_stationne.php?mainmenu=gestionflotte&leftmenu=listevehicule&etat=stationne');
...
$nb_page = GETPOST('nbpage','int')?:1;
			if($action == "rechercher"){
				...
				$recherche_numero_chassis = GETPOST("recherche_numero_chassis", "alpha");
				$recherche_type_document = GETPOST("recherche_type_document", "alpha");
			}
...
if($action == "liste" || $action == "rechercher"){
	...
	$sql_vehicule = 'SELECT vh.*, tv.nom as tvnom, td.nom as tdnom FROM '.MAIN_DB_PREFIX.'vehicule as vh';
	...
	$sql_vehicule .= ' LEFT JOIN '.MAIN_DB_PREFIX.'type_document as td on dv.fk_type_document = td.rowid';
	...
	if($recherche_type_document){
		$sql_vehicule .= ' AND vh.rowid IN (SELECT fk_vehicule FROM '.MAIN_DB_PREFIX.'document_vehicule WHERE fk_type_document='.$recherche_type_document.')';
	}
	...
	if($tri){
		...
		elseif($tri == "type_document")
			$sql_vehicule .= " ORDER BY td.nom";
		elseif($tri == "desc")
	...
	print '<td align="center" style="padding: 5px; width: '.$largeur.';"><select id="recherche_type_document" name="recherche_type_document" style="width: 120px;">';
	print '<option></option>';
    ...
    if($res){
		...
		while ($obj_type_document = $db->fetch_object($res)) {
			if(!empty(GETPOST('recherche_type_document', 'int'))){
				if($obj_type_document->rowid == GETPOST('recherche_type_document', 'int'))
 ...
 print '<td align="center" style="25%; color: darkblue;" ><label><a href="'.$_SERVER["PHP_SELF"].'?mainmenu=gestionflotte&leftmenu=listevehicule&tri=type&limit='.$limit.'&arret='.$arret.'&nbpage='.$nb_page.'&action=rechercher&recherche_reference='.$recherche_reference.'&recherche_nom='.$recherche_nom.'&recherche_type='.$recherche_type.'&recherche_numero_chassis='.$recherche_numero_chassis.'&recherche_code_immobilisation='.$recherche_code_immobilisation.'&recherche_plaque_immatriculation='.$recherche_plaque_immatriculation.'&recherche_type_document='.$recherche_type_document.'&etat='.$etat.'" title="Trié par nom de type véhicule">Type</a></label></td>';
  print '<td align="center" style="25%; color: darkblue;" ><label><a href="'.$_SERVER["PHP_SELF"].'?mainmenu=gestionflotte&leftmenu=listevehicule&tri=type_document&limit='.$limit.'&arret='.$arret.'&nbpage='.$nb_page.'&action=rechercher&recherche_reference='.$recherche_reference.'&recherche_nom='.$recherche_nom.'&recherche_type='.$recherche_type.'&recherche_numero_chassis='.$recherche_numero_chassis.'&recherche_code_immobilisation='.$recherche_code_immobilisation.'&recherche_plaque_immatriculation='.$recherche_plaque_immatriculation.'&recherche_type_document='.$recherche_type_document.'&etat='.$etat.'" title="Trié par nom de type document">Type Doc.</a></label></td>';
 ...
 print '</tr>';
	...
	$actl[1] = img_picto($langs->trans("Activated"), 'switch_on', 'class="size30x"');
		...
		while ($i < $num){
				...
				print '<td align="center">'.($obj_liste[$i]->tdnom?:"N/A").'</td>';
	...
	if($num>$limit){
		if($nb_page!= 1)
			if($nb==0 && 1 < ($nb))
				$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=0&nbpage=1&action=recherche&recherche_reference=".$recherche_reference."&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>Debut</b>    </a>&nbsp;&nbsp;";
			else if(1 < ($nb+1))
			$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=0&nbpage=1&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>Debut</b>    </a>&nbsp;&nbsp;";
		...
		if($arret > $limit){
			...
			if($nb_page-3>=0)
				$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".($limit*($nb_page-3))."&nbpage=".($nb_page-2)."&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>".($nb_page -2)."</b></a>&nbsp;&nbsp;";

			if($nb_page-2>=0)
						$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".($limit*($nb_page-2))."&nbpage=".($nb_page-1)."&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>".($nb_page-1)."</b></a>&nbsp;&nbsp;";
			
			
			if($nb_page-1>=0)
					$page_link .= "<a style='background-color: yellow;' href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".($limit*($nb_page-1))."&nbpage=".($nb_page)."&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>".($nb_page)."</b></a>&nbsp;&nbsp;";

		

			
				if(	(($nb_page+1) <= ($nb)))
					$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".($limit*$nb_page)."&nbpage=".($nb_page+1)."&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>".($nb_page + 1)."</b></a>&nbsp;&nbsp;";

			
				if((($nb_page+2) <= ($nb)))
					$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".($limit*($nb_page +1))."&nbpage=".($nb_page+2)."&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>".($nb_page + 2)."</b></a>&nbsp;&nbsp;";
					
				
				if((($nb_page+3) <= ($nb)))
					$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".($limit*($nb_page+2))."&nbpage=".($nb_page+3)."&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>".($nb_page + 3)."</b></a>&nbsp;&nbsp;";
				...
				if( 1 <= ($nb))
					...
					$page_link .= "<a style='background-color: yellow;' href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=0&nbpage=1&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>1</b></a>&nbsp;&nbsp;";
			
			
				if(2 <= ($nb))
					
					$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".$limit."&nbpage=2&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>2</b></a>&nbsp;&nbsp;";
			
			
				if(3 <= ($nb))
					
					$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".($limit*2)."&nbpage=3&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>3</b></a>&nbsp;&nbsp;";
				
				if(4 <= ($nb))
					
					$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".($limit*3)."&nbpage=4&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>4</b></a>&nbsp;&nbsp;";

				if(5 <= ($nb))
					
					$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".($limit*4)."&nbpage=5&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'><b>5</b></a>&nbsp;&nbsp;";



		}
		if($nb_page != ($nb)  )
				$page_link .= "<a href='".$_SERVER["PHP_SELF"]."?mainmenu=gestionflotte&leftmenu=listevehicule&limit=".$limit."&arret=".($limit*($nb-1))."&nbpage=".($nb)."&action=recherche&recherche_reference=".$recherche_reference."&action=recherche&recherche_reference=".$recherche_reference."r&recherche_nom=".$recherche_nom."&recherche_type=".$recherche_type."&recherche_numero_chassis=".$recherche_numero_chassis."&recherche_code_immobilisation=".$recherche_code_immobilisation."&recherche_plaque_immatriculation=".$recherche_plaque_immatriculation."&recherche_type_document=".$recherche_type_document."&etat=".$etat."&tri=".$tri."' style='padding: 5px'>      <b>Fin</b></a>&nbsp;&nbsp;";
